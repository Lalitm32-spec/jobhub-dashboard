...
import { Briefcase, FileText, Mail, BarChart2 } from "lucide-react"
...
const defaultTiers = [
  {
    ...
    features: [
      {
        name: "10 job applications/month",
        description: "Track your most important applications",
        included: true,
      },
      {
        name: "Basic resume templates",
        description: "Access to essential resume templates",
        included: true,
      },
      {
        name: "Email tracking",
      ...
      },
      {
        ...
        description: "Access to our community forum",
        included: true,
      },
    ],
  },
    ...
    features: [
      {
        ...
        description: "Track as many applications as you need",
        included: true,
      },
      {
      ...
      },
      {
        ...
        description: "Reach out to potential employers effectively",
        included: true,
      },
      {
